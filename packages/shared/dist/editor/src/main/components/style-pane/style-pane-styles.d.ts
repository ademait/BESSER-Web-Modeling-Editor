...
export declare const Color: import("styled-components").StyledComponent<"button", any, Props, never>;
...
export declare const FieldRow: import("styled-components").StyledComponent<"div", any, {}, never>;
export {};
