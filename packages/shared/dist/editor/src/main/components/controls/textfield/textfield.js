...
export class Textfield extends Component {
    ...
    render() {
        ...
        return (React.createElement(StyledTextfield, { as: props.multiline ? 'textarea' : 'input', maxLength: props.multiline ? undefined : 20000, key: this.state.key, ...props, size: size, defaultValue: value, onChange: this.onChange, onKeyUp: this.onKeyUp, onBlur: this.onBlur, ref: this.ref }));
    }
    focus() {
        if (this.ref.current) {
