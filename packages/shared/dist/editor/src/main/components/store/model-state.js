...
export class ModelState {
    ...
    static toModel(state) {
        ...
        // Include reference diagram data for ObjectDiagrams
        const referenceDiagramData = (state.diagram.type === 'ObjectDiagram') ? diagramBridge.getClassDiagramData() : undefined;
        return {
            version: '3.0.0',
