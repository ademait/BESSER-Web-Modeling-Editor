    ...
    render() {
        ...
        return (React.createElement("svg", { ...props, ...relationship.bounds, visibility: reconnecting ? 'hidden' : undefined, pointerEvents: disabled ? 'none' : 'stroke' },
            ...
            midPoints.map((point, index) => {
                return (React.createElement("circle", { visibility: selectionBoxActive || interactive || interactable || readonly ? 'hidden' : undefined, pointerEvents: selectionBoxActive || interactive || interactable || readonly ? 'none' : 'all', style: { cursor: 'grab', pointerEvents: 'stroke' }, key: props.id + '_' + point.mpX + '_' + point.mpY, cx: point.mpX, cy: point.mpY, r: "15", onPointerDown: (e) => {
                        this.onPointerDown(e, index, point);
                    }, fill: "transparent", stroke: highlight, strokeWidth: "7" }));
            })));
    }
}
