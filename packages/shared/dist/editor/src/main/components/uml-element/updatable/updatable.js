...
export const updatable = (WrappedComponent) => {
    class Updatable extends Component {
        ...
        render() {
            const { updateStart, deleteElement, getElementById, getRelationshipById, hovered, selected, isObjectDiagram, openAssociationPopup, ...props } = this.props;
            ...
            return (React.createElement(WrappedComponent, { ...props },
                ...
                isObjectDiagram && (React.createElement(FloatingButton, { style: {
                        opacity: selected ? 1 : 0,
                        transform: `translate(${baseCoordinates.x}px, ${selected ? baseCoordinates.y - 90 : baseCoordinates.y}px)`,
                    }, onClick: this.onAdd },
                    React.createElement(AddIcon, { x: 7, y: 7 })))));
        }
    }
