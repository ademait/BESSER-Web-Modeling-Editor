export declare const UMLRelationshipRepository: {
    startReconnecting: (endpoint: "source" | "target", id?: string | string[]) => import("../../utils/actions/actions").AsyncAction;
    reconnect: (target: import("../uml-element/uml-element-port").IUMLElementPort) => import("../../utils/actions/actions").AsyncAction;
    endReconnecting: (id?: string | string[]) => import("../../utils/actions/actions").AsyncAction;
    get: (element?: import("../uml-element/uml-element").IUMLElement) => import("./uml-relationship").UMLRelationship | null;
    ...
    flip: (id?: string | string[]) => import("../../utils/actions/actions").AsyncAction;
