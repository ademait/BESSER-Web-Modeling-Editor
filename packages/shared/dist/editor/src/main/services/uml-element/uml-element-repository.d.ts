export declare const UMLElementRepository: {
    ...
    startConnecting: (direction: import("./uml-element-port").Direction | import("./uml-element-port").Direction[], id?: string | string[]) => import("../../utils/actions/actions").AsyncAction;
    connect: (target: import("./uml-element-port").IUMLElementPort | import("./uml-element-port").IUMLElementPort[], source?: import("./uml-element-port").IUMLElementPort | import("./uml-element-port").IUMLElementPort[]) => import("../../utils/actions/actions").AsyncAction;
    endConnecting: (port?: import("./uml-element-port").IUMLElementPort | import("./uml-element-port").IUMLElementPort[]) => import("../../utils/actions/actions").AsyncAction;
    startResizing: (id?: string | string[]) => import("../../utils/actions/actions").AsyncAction;
    resize: (delta: {
        width: number;
        height: number;
    }, resizeFrom: import("./uml-element").ResizeFrom, id?: string | string[]) => import("../../utils/actions/actions").AsyncAction;
    endResizing: (id?: string | string[]) => import("../../utils/actions/actions").AsyncAction;
    startMoving: (id?: string | string[]) => import("../../utils/actions/actions").AsyncAction;
    move: (delta: {
        x: number;
        y: number;
    }, id?: string | string[]) => import("../../utils/actions/actions").AsyncAction;
    endMoving: (id?: string | string[], keyboard?: boolean) => import("../../utils/actions/actions").AsyncAction;
    ...
    select: (id?: string | string[], overwrite?: boolean) => import("../../utils/actions/actions").AsyncAction;
    deselect: (id?: string | string[]) => import("../../utils/actions/actions").AsyncAction;
    ...
    create: <T extends import("./uml-element").IUMLElement>(value: T | T[], owner?: string) => import("../../utils/actions/actions").AsyncAction;
    get: (element?: import("./uml-element").IUMLElement) => import("./uml-element").UMLElement | null;
    getById: (id: string) => import("../../utils/actions/actions").AsyncAction<import("./uml-element").UMLElement | null>;
    update: <T extends import("./uml-element").IUMLElement>(id: string | string[], values: Partial<T>) => import("./uml-element-types").UpdateAction<T>;
    delete: (id?: string | string[]) => import("../../utils/actions/actions").AsyncAction;
    add: (id?: string | string[]) => import("../../utils/actions/actions").AsyncAction;
