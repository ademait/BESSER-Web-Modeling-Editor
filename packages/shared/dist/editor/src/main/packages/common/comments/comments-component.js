...
export const CommentsComponent = ({ element, fillColor }) => {
    ...
    return (React.createElement("g", null,
        ...
        `, fillColor: fillColor || element.fillColor, strokeColor: element.strokeColor, strokeWidth: "1.5", strokeMiterlimit: "10" }),
        React.createElement(Multiline, { x: element.bounds.width / 2, y: (element.bounds.height - pointerHeight) / 2, width: element.bounds.width - 10, height: element.bounds.height - pointerHeight - 10, fontWeight: "normal", fill: element.textColor }, element.name)));
};
