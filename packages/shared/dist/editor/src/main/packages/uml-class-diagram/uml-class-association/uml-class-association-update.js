...
class ClassAssociationComponent extends Component {
    ...
    render() {
        ...
        return (React.createElement("div", null,
            ...
            !isInheritance && (React.createElement("section", null,
                React.createElement(Flex, null,
                    React.createElement(Body, { style: { marginRight: '0.5em' } }, this.props.translate('popup.name')),
                    React.createElement(Textfield, { value: element.name, onChange: (value) => this.props.update(element.id, { name: value }), placeholder: "Association name" })),
                React.createElement(Divider, null))),
            React.createElement("section", null,
                ...
                React.createElement(Divider, null)),
            !isInheritance && (React.createElement(React.Fragment, null,
                React.createElement("section", null,
                    ...
                    React.createElement(Flex, null,
                        ...
                        React.createElement(Textfield, { style: { minWidth: 0 }, gutter: true, value: element.source.multiplicity, onChange: this.onUpdate('multiplicity', 'source'), autoFocus: true, placeholder: `1..1` })),
                    React.createElement(Flex, null,
                ...
                React.createElement("section", null,
                    ...
                    React.createElement(Flex, null,
                        React.createElement(Body, { style: { marginRight: '0.5em' } }, this.props.translate('popup.multiplicity')),
                        React.createElement(Textfield, { style: { minWidth: 0 }, gutter: true, value: element.target.multiplicity, onChange: this.onUpdate('multiplicity', 'target'), placeholder: `1..1` })),
                    React.createElement(Flex, null,
                        React.createElement(Body, { style: { marginRight: '0.5em' } }, this.props.translate('popup.role')),
