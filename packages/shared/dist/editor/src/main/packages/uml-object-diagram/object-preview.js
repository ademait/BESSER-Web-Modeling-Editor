...
const composeIconObjectPreview = (layer, translate) => {
    const elements = [];
    ...
    if (shouldShowInstances) {
        ...
        classesToShow.forEach((classInfo, classIndex) => {
            ...
            if (iconElement) {
                ...
                elements.push(...instanceObject.renderObject(layer, instanceAttributes, iconElement));
            }
            else {
                elements.push(...instanceObject.render(layer, instanceAttributes));
            }
...
const composeNormalObjectPreview = (layer, translate) => {
    const elements = [];
