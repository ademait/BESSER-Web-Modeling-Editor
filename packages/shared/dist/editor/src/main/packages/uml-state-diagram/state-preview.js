...
const computeDimension = (scale, value) => {
    return Math.round((scale * value) / 10) * 10;
};
export const composeStatePreview = (layer, translate) => {
    const elements = [];
    ...
    elements.push(...stateWithBody.render(layer, [stateBody]));
    ...
    elements.push(...stateWithBothBodies.render(layer, [stateBody2, fallbackBody]));
    // State Initial Node
...
//# sourceMappingURL=state-preview.js.map