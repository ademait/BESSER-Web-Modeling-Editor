...
export class AgentStateTransitionInit extends UMLRelationshipCenteredDescription {
    constructor(values) {
        super(values);
        this.type = AgentRelationshipType.AgentStateTransitionInit;
        this.params = {};
        this.params = {};
        if (values?.params) {
...
//# sourceMappingURL=agent-state-transition-init.js.map