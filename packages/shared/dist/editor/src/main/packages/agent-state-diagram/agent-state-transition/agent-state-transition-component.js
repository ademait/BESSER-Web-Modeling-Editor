...
export const AgentStateTransitionComponent = ({ element }) => {
    ...
    return (React.createElement("g", null,
        ...
        React.createElement("text", { x: position.x, y: position.y, ...layoutText(direction), pointerEvents: "none", style: { ...fill } }, getConditionName()),
        React.createElement("text", { x: position.x, y: position.y + 30, ...layoutText(direction), pointerEvents: "none", style: { ...fill } }, getConditionValue())));
};
//# sourceMappingURL=agent-state-transition-component.js.map