...
### Step 2: Add Sidebar Button in `WorkspaceSidebar.tsx`

**File:** `src/main/components/sidebar/WorkspaceSidebar.tsx`
...
### Step 4: Add Color Badge in `ProjectSettingsPanel.tsx`

**File:** `src/main/components/project/ProjectSettingsPanel.tsx`
