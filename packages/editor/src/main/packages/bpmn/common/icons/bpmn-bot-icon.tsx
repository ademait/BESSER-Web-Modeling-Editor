...
// Direct port of extension/concreteSyntax/bot-icon.svg (clean path). The "agent
// marker" of the Agentic BPMN paper §4.4 — shared by every agentic element.
export const BPMNBotIcon: FunctionComponent<React.SVGProps<SVGSVGElement>> = (props) => (
  <svg {...props} height={16} width={16} viewBox="0 0 24 24" fill="currentColor">
